...
description: "B.Tech. capstone: topology optimization and generative design for metal additive manufacturing of spur gears."
---
...
<div class="pkj-project-page">
  ...
  <div class="pkj-project-hero">
    ...
    <div class="pkj-project-meta">
      ...
      <div class="pkj-meta-item"><strong>Advisor</strong>Dr. K. Palaksha Reddy</div>
      <div class="pkj-meta-item"><strong>Team</strong><a href="https://www.linkedin.com/in/sanjaybaskar29/" target="_blank" rel="noopener">Sanjay Baskar</a></div>
    </div>
  </div>
  ...
  <div class="pkj-project-layout">
    <div class="pkj-project-main">
      ...
      <div class="pkj-project-summary">
        ...
        <p>The goal was not just weight reduction. The designs had to work for metal additive manufacturing, so every material removal decision had to account for manufacturability, not fight against it. That meant thinking about overhangs, support structures, and print orientation from the start, not after the fact.</p>
        <p>Final designs were evaluated on weight savings, stress distribution, estimated AM cost, and print time. The topology-optimized and generatively designed variants each came with tradeoffs. Documenting those tradeoffs honestly was as important as finding the lightest geometry.</p>
      </div>
      ...
      <div class="pkj-project-gallery">
        <div class="pkj-gallery-grid">
          <div class="pkj-gallery-item"><img class="pkj-gallery-img" src="/images/BTech Projects/GAMTO/OG Design Isometric.jpg" alt="Original Gear Design"></div>
          <div class="pkj-gallery-item"><img class="pkj-gallery-img" src="/images/BTech Projects/GAMTO/Generative Design Spur Gear.jpg" alt="Generative Design Output"></div>
          <div class="pkj-gallery-item"><img class="pkj-gallery-img" src="/images/BTech Projects/GAMTO/Topology Optimized Design.jpg" alt="Topology Optimized Design"></div>
          ...
          <div class="pkj-gallery-item"><img class="pkj-gallery-img" src="/images/BTech Projects/GAMTO/FD1 Iso View.jpg" alt="Final Design 1 Isometric"></div>
          <div class="pkj-gallery-item"><img class="pkj-gallery-img" src="/images/BTech Projects/GAMTO/FD2 Iso View.jpg" alt="Final Design 2 Isometric"></div>
          <div class="pkj-gallery-item"><img class="pkj-gallery-img" src="/images/BTech Projects/GAMTO/FD3 Iso View.jpg" alt="Final Design 3 Isometric"></div>
        </div>
      </div>
    ...
    <div class="pkj-project-sidebar">
      <div class="pkj-sidebar-card">
        ...
        <a class="pkj-pdf-link" href="/assets/pdfs/Final Draft Maxi Project Report - 9054 & 9199.docx.pdf" target="_blank" rel="noopener">
      ...
      <div class="pkj-sidebar-card">
        ...
        <div class="pkj-sidebar-row"><span class="pkj-sidebar-row-label">Type</span><span class="pkj-sidebar-row-value">B.Tech. Capstone</span></div>
