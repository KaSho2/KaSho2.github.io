...
description: "Built and compared classification models for breast cancer diagnosis, including supervised and unsupervised approaches."
---
...
<div class="pkj-project-page">
  ...
  <div class="pkj-project-hero">
    ...
    <div class="pkj-project-meta">
      ...
      <div class="pkj-meta-item"><strong>Advisor</strong>Dr. Ari Smith</div>
      <div class="pkj-meta-item"><strong>Team</strong>
        <a href="https://www.linkedin.com/in/eli-padilla/" target="_blank" rel="noopener">Eli Padilla</a>,
  ...
  <div class="pkj-project-layout">
    <div class="pkj-project-main">
      ...
      <div class="pkj-project-summary">
        ...
        <p>The more interesting parts of the project were not the final accuracy numbers. They were the moments where preprocessing choices visibly shifted model performance, and the exercise of communicating those tradeoffs clearly. A model that performs well but cannot be explained to a medical reviewer is not useful in this context. Communicating the results was treated as seriously as generating them.</p>
      </div>
    ...
    <div class="pkj-project-sidebar">
      <div class="pkj-sidebar-card">
        ...
        <a class="pkj-pdf-link" href="/assets/pdfs/Predictive Breast Cancer Classification in the U.S. - Project Report - 521.pdf" target="_blank" rel="noopener">
      ...
      <div class="pkj-sidebar-card">
        ...
        <div class="pkj-sidebar-row"><span class="pkj-sidebar-row-label">Course</span><span class="pkj-sidebar-row-value">ISyE 521</span></div>
